...
type User struct {
	...
	HashUID         string    `boil:"hash_uid" json:"hash_uid" toml:"hash_uid" yaml:"hash_uid"`
	Name            string    `boil:"name" json:"name" toml:"name" yaml:"name"`
	Email           string    `boil:"email" json:"email" toml:"email" yaml:"email"`
	ProfileImageURL string    `boil:"profile_image_url" json:"profile_image_url" toml:"profile_image_url" yaml:"profile_image_url"`
...
var UserWhere = struct {
	ID              whereHelperint
	HashUID         whereHelperstring
	Name            whereHelperstring
	Email           whereHelperstring
	ProfileImageURL whereHelperstring
	CreatedAt       whereHelpertime_Time
	UpdatedAt       whereHelpertime_Time
}{
	ID:              whereHelperint{field: "`users`.`id`"},
	HashUID:         whereHelperstring{field: "`users`.`hash_uid`"},
	Name:            whereHelperstring{field: "`users`.`name`"},
	Email:           whereHelperstring{field: "`users`.`email`"},
	ProfileImageURL: whereHelperstring{field: "`users`.`profile_image_url`"},
...
var (
	userAllColumns            = []string{"id", "hash_uid", "name", "email", "profile_image_url", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"hash_uid", "name", "email", "profile_image_url"}
